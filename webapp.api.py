...
# NOTE: style.css and app.js are served automatically by Flask's built-in
# static handler (static_folder=WEBAPP_DIR, static_url_path=""), so we do NOT
# register a second catch-all route here — doing so previously collided with
# Flask's own static route and caused random 404s.
